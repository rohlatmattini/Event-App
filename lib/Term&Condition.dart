...
class TermsAndConditionsScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _definition('Application',
                'means the software program provided by the Company downloaded by You on any electronic device, named Event App'),
            _definition('Application Store',
            ...
            _definition('Affiliate',
                'means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.'),
            _definition('Country', 'refers to: Syria'),
            _definition('Company',
                '(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Event App.'),
            _definition('Device',
                'means any device that can access the Service such as a computer, a cellphone or a digital tablet.'),
            _definition('Service', 'refers to the Application.'),
            _definition('Terms and Conditions',
            ...
            _definition('Third-party Social Media Service',
            ...
            SizedBox(height: 20),
            _sectionTitle('"AS IS" and "AS AVAILABLE" Disclaimer'),
            Text(
            ...
            SizedBox(height: 20),
            _sectionTitle('Disputes Resolution'),
            Text(
                'If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.'),
            SizedBox(height: 20),
            _sectionTitle('For European Union (EU) Users'),
            Text(
                'If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.'),
            SizedBox(height: 20),
            _sectionTitle('United States Legal Compliance'),
            Text(
                'You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.'),
            SizedBox(height: 20),
            _sectionTitle('Severability and Waiver'),
            _subSectionTitle('Severability'),
            Text(
                'If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.'),
            _subSectionTitle('Waiver'),
            Text(
                'Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party\'s ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.'),
            SizedBox(height: 20),
            _sectionTitle('Translation Interpretation'),
            Text(
                'These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.'),
            SizedBox(height: 20),
            _sectionTitle('Changes to These Terms and Conditions'),
            Text(
            ...
            Text('By email: malazes952003@gmail.com'),
          ],
        ),
      ),
    );
  ...
  Widget _definition(String term, String definition) {
    return Padding(
